...
namespace Freenet.FCP2
{
    ...
    public class FCP2
    {
        ...
        public void ClientPutDirect(string uri, string metadataContentType, string identifier, VerbosityEnum? verbosity,
        ...
        public void ClientPutDisk(string uri, string metadataContentType, string identifier, VerbosityEnum? verbosity,
                                  long? maxRetries, PriorityClassEnum? priorityClass, bool? getCHKOnly, bool? global,
                                  bool? dontCompress, string clientToken, PersistenceEnum? persistence, string targetFilename,
        ...
        public void ClientPutRedirect(string uri, string metadataContentType, string identifier, VerbosityEnum? verbosity,
                                      long? maxRetries, PriorityClassEnum? priorityClass, bool? getCHKOnly, bool? global,
                                      bool? dontCompress, string clientToken, PersistenceEnum? persistence, string targetFilename,
                              ...
                              string allowedMimeTypes, ReturnTypeEnum? returnType, string filename, string tempFilename)
        {
            ...
            if (priorityClass != null)
                fnwrite.WriteLine("PriorityClass=" + ((long)priorityClass.Value));
            if (global.HasValue && global.Value && persistence.Value == PersistenceEnum.Connection)
